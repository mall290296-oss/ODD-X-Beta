  ...
  return (
    <div className="min-h-screen bg-slate-50 text-slate-900 font-sans selection:bg-blue-200">
        ...
        <div className="max-w-7xl mx-auto flex justify-between items-center">
          <div className="flex items-center gap-3 cursor-pointer group" onClick={() => setActiveTab("Accueil")}>
            <div className="w-12 h-10 flex items-center justify-center overflow-hidden">
              <img src={LOGO_URL} alt="Logo Polytechnique" className="w-full h-full object-contain group-hover:scale-110 transition-transform duration-300" />
            </div>
      ...
      <div className="max-w-7xl mx-auto px-8 py-12">
        ...
        {/* RESTAURATION SECTION CONTACT ORIGINALE */}
        {activeTab === "Contact" && (
